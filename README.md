...
**Live URL:** https://muralpay.vercel.app/
...
**~20 min** — Deploy is live at https://muralpay.vercel.app/. Added a Neon database via the Vercel integration and set up Prisma following the NestJS recipe. Got env variables locally via `vercel env pull`.
